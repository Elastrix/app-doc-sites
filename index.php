		...
		<!-- Header -->
			<header id="header">
					...
					<a href="http://elastrix.io" target="_blank">
						<img src="https://elastrix.io/images/logo.svg" style="width:98%;"/>
					</a>
					</h1>
				<h1><strong>LEMP</strong> with Webmin<br />
				Ubuntu 16.04, NGINX 1.14, MySQL 5.7 and PHP (FPM) 7<br/>
			...
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						...
						<p>Our battle tested, scablable and performance tweaked LEMP stack is perfect for development all the way to product ready 
